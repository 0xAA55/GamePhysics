...
class SceneDemo : public AppFrame
{
public:
	SceneManager Scene;
...
#undef FACE
	...
	{
		BoxMesh.VertexBufferVector.Clear();
		BoxMesh.IndexBufferVector.Clear();
		BoxMesh.InstanceBufferVector.Clear();
		ObjMesh.VertexBufferVector.Clear();
		ObjMesh.IndexBufferVector.Clear();
		ObjMesh.InstanceBufferVector.Clear();
	}
